...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run walk-forward validation with rolling or expanding windows."
    )
    parser.add_argument("--data", required=True, help="Input OHLCV CSV path")
    parser.add_argument("--models-dir", required=True, help="Output directory for fold model snapshots")
    parser.add_argument("--report", required=True, help="CSV path for walk-forward fold metrics")
